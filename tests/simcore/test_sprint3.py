...
class TestSprint3Integration:
    ...
    def test_damage_matrix_in_combat(self):
        ...
        attacker = {
            ...
            "attack_ground": 20, "attack_air": 0,
            "attack_range_ground": 4.0, "attack_range_air": 0,
            "weapon_type_ground": "concussive", "weapon_type_air": "none",
        ...
        target = {
            ...
            "attack_ground": 30, "attack_air": 0,
            "attack_range_ground": 6.0, "attack_range_air": 0,
            "weapon_type_ground": "explosive", "weapon_type_air": "none",
            "cooldown_ground": 30, "cooldown_air": 0,
            "cooldown_timer": 30,
            "armor": 1, "armor_type": "heavy",
            "domain": "ground",
            "is_idle": True, "carry_amount": 0, "carry_capacity": 0,
            "target_x": None, "target_y": None,
            "returning_to_base": False, "attack_target_id": "",
